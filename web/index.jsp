            ...
            <div class="col-lg-12">
                    ...
                    <table class="table table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            %>
                            <%
                                ResultSet livros = b.selectAllLivroofEstoque();
                                while(livros.next()){
                            %>
                        <form method="post" action="index.jsp">
                            ...
                            <tr>
                                ...
                                <td>
                                    <% 
                                        if(livros.getString("quantidade") == "" || livros.getString("quantidade") == "0" || livros.getString("quantidade") == null || Integer.parseInt(livros.getString("quantidade")) <= 0){
                                    %>
                                    ...
                                    <input name="idproduto" type="hidden" value="<%=livros.getString("id")%>">
