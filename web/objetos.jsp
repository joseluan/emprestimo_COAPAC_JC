...
<html lang="pt-br">
    <head>
        ...
        <meta name="description" content="Lista de todos os objetos e atalhos para excluir e editar objetos">
        ...
        <div id="conteudo" style="margin-top: 60px;">    
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <i class="fa fa-desktop"></i> objetos
                    </li>
                </ol>
            </div>
            <!-- Formulários -->
            <form action="objetos.jsp" method="POST">
                <table>
                    <tr>
            ...
            <center>
                ...
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                        <%
                            ResultSet objeto = b.selectAllObjetoNome(request.getParameter("nome"));
                            while (objeto.next()) {
                        %>
                        <tr>
                            <td><%=objeto.getString("nome")%></td>
                            <td><%=objeto.getString("volume")%></td>
                            <td><%=objeto.getString("quantidade")%></td>
                            <td>
                                <form action="editar_l.jsp" method="POST">
                                    <input type="hidden" name="idprodt" value="<%=objeto.getString("id")%>">
